...
from webuser.smpl_handpca_wrapper_HAND_only import ready_arguments
...
class ManoLayer(Module):
    ...
    def __init__(self,
        ...
        self.register_buffer('th_faces',
                             torch.Tensor((smpl_data['f'].astype(np.int32)).copy()).long())
    ...
    def forward(self,
        ...
        # print(th_v_shaped.is_cuda, self.th_posedirs.is_cuda, th_pose_map.is_cuda)
